...
# DB_FAISS_PATH ="./db_faiss" # Path to your FAISS index
...
# Allow all origins for CORS (you can adjust this as needed)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Allow all origins, or specify your front-end URL here
